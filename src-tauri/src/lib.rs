...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::course_profile_settings_get,
            commands::course_profile_settings_set,
            commands::course_profile_import_preview,
            commands::course_profile_confirm_import,
            commands::course_profile_list,
            commands::course_profile_download_template,
            commands::course_profile_update_course,
            commands::course_profile_delete_course,
            commands::course_profile_summary,
            ...
            commands::milestone_proof_materials_open,
